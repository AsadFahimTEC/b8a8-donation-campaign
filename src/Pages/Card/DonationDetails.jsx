...
const DonationDetails = ({card}) => {
    ...
    return (
        ...
        <div className="relative mx-4 mt-4 h-76 overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700">
          ...
          <button onClick={handleAddToDonations} className="absolute bottom-5 left-28 p-4 text-[#FFF] text-sm font-semibold rounded" style={{background: text_button_bg_color}}>Donate: ${price}</button>
